...
export class MoleComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    const startButtonClicked$ = fromEvent(this.startButton.nativeElement, 'click').pipe(
    ...
    const delayGameStart$ = startButtonClicked$.pipe(delay(delayTime * 1000), shareReplay(1));
